...
반도체/AI 반도체, 생성형 AI·AI 에이전트, GPU 클라우드·데이터센터, AI 스타트업/투자 동향, 그리고 주요 AI 기업(노타, 래블업, 마키나락스, 베슬AI, 업스테이지, 사이오닉AI, 리벨리온, 퓨리오사AI 등)의 국내외 뉴스를 클리핑합니다.
...
- categories(카테고리): 다음 5개 핵심 분류 중 해당하는 것을 우선 배정하고, 보조 분류를 더할 수 있다 (배열, 한 기사에 여러 개 가능). [${CATEGORY_OPTIONS.join(", ")}]
  · 경쟁사 = 동종 AI 인프라/모델/반도체 경쟁사의 동향·수주·전략
  · 투자 = 펀딩 라운드, IPO/상장, M&A, 밸류에이션
  · 기술 = 모델·추론 최적화, 반도체·NPU 기술, 신규 아키텍처 등 기술 자체
  · 제품 = 신제품/모델/플랫폼 출시·런칭·업데이트
  · 행사정보 = 컨퍼런스·전시회·박람회·키노트 등 일정/개최 소식
  · (보조) 자사 = 아크릴 직접 언급 / 산업트렌드 = 시장 규모·거시 흐름 / 정책규제 / 논문·오픈소스 / 효율화기술 / 기타산업
