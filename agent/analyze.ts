...
- categories(카테고리): 다음 4개 핵심 분류 중 해당하는 것을 우선 배정하고, 보조 분류를 더할 수 있다 (배열). [${CATEGORY_OPTIONS.join(", ")}]
  · 경쟁사 = 동종 AI 인프라/모델/반도체 경쟁사의 제품·수주·동향
  · 산업트렌드 = 시장 규모·구조 변화, 빅테크 동향, 데이터센터·전력 등 거시 흐름
  · 기술지식 = 모델·추론 최적화, 반도체·NPU 기술, 신규 모델/아키텍처 등 기술 자체
  · 투자 = 펀딩 라운드, IPO/상장, M&A, 밸류에이션
  · (보조) 자사 = 아크릴 직접 언급 / 정책규제 = 정부정책·규제 / 논문·오픈소스 / 효율화기술 / 기타산업
